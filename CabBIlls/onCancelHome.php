...
function validate(){
               ...
               if (isEmpty(document.myForm.name)){
          ...
          <br>
             ...
             <TR>
                                                                    <Th bgcolor="Beige" align="left">Employee Name</th>
                                                                     <TD>
                                                                       <INPUT type="text" name="name" style="background-color: PowderBlue;font-weight: bold;border: 0;" size="25"  value="Shashank Srivastava" required autofocus>
                                                                         </TD>
                                                                          </TR>
  ...
  <TR>
              ...
              <tr>
                  ...
                  <td colspan=3><input type="text" style="background-color: PowderBlue;font-weight: bold;border: 0;" name="mname" size="25" value="Managerś name" required>
                            ...
                            <tr>
                     <th  bgcolor="Beige" align="left">Bill Submission Date</th>
